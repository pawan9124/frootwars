...
var SceneManager = function () {
  ...
  _createClass(SceneManager, [{
    ...
    value: function showMenu() {
      this.gameOverScore.classList.remove('active');
...
var LevelData = function LevelData() {
  ...
  this.levels = [{ gapX: 5, gapY: 30, widthDiff: 0, total: 5, coinChance: 0.4, enemyChance: 0.2 }, { gapX: 10, gapY: 30, widthDiff: 30, total: 10, coinChance: 0.6, enemyChance: 0.3 }, { gapX: 20, gapY: 30, widthDiff: 30, total: 10, coinChance: 0.6, enemyChance: 0.2 }, { gapX: 40, gapY: 40, widthDiff: 100, total: 50, coinChance: 0.8, enemyChance: 0 }, { gapX: 20, gapY: 30, widthDiff: 30, total: 100, coinChance: 0.6, enemyChance: 0.4 }];
};
...
var ScoreCalculator = function () {
  ...
  _createClass(ScoreCalculator, [{
    ...
    value: function increaseScore(level) {
      //Note: levle starts at 0. Expotential incremental.
...
var Coin = function (_GameObject2) {
  ...
  function Coin() {
    ...
    return _possibleConstructorReturn(this, (Coin.__proto__ || Object.getPrototypeOf(Coin)).call(this, new lib.CoinGraphic()));
  }
